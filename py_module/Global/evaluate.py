...
def plot_results_figure():
    with open("./results/global_results_v2.csv") as f:
        ...
        if '_' not in model_name or model_name.index('_') + 1 == len(model_name) - 1:
            ...
            # print(model_name[model_name.index('_')+1:len(model_name)])
            ...
            # print(model_)
        # plt.title('The trade-off between Lipschitz constant K* and noisy level in the {} model'.format(model_))
